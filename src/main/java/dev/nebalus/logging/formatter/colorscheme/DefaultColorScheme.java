...
public class DefaultColorScheme extends ColorScheme {
	...
	{
		super();
		registerScheme(LogLevel.EMERGENCY, AnsiFormatingCode.STYLE_SLOW_BLINK, AnsiFormatingCode.STYLE_INTENSITY_BRIGHT, AnsiFormatingCode.COLOR_YELLOW_FG_BRIGHT, AnsiFormatingCode.COLOR_RED_BG);
		registerScheme(LogLevel.ALERT, AnsiFormatingCode.STYLE_INTENSITY_BRIGHT, AnsiFormatingCode.COLOR_YELLOW_FG, AnsiFormatingCode.COLOR_RED_BG_BRIGHT);
		registerScheme(LogLevel.FATAL, AnsiFormatingCode.STYLE_INTENSITY_BRIGHT, AnsiFormatingCode.COLOR_WHITE_FG, AnsiFormatingCode.COLOR_RED_BG_BRIGHT);
